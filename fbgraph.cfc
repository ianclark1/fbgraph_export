<cfcomponent output="false">
	...
	<cffunction name="getAccessToken" access="public" output="true" returntype="any" hint="gets a user ID">
		 <cfargument name="prefix" type="string" required="false" default="access_token=">
  	     ...
  	     <cfset var access_token = get_facebook_cookie(variables.appID,arguments.prefix,13,0) />
		<cfset var access_token = "101045733272743|2.L4raumgIOPqq_NsY9l69bw__.3600.1279677600-31504595|jGx96uXXreZ13o5h4gOVACleevg.">
